...
| /space_type  | Add a kind of space to the filter (wormhole, high-sec, low-sec, null-sec, Pochven, abyssal). Combine with `/filter_mode and` to restrict your other rules to that space. Use `Everywhere` to clear it.                                                                                                                                                                  |
